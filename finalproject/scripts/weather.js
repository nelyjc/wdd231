const weatherURL = `https://api.openweathermap.org/data/3.0/onecall?lat=40.2338&lon=-111.6585&appid=7413de7dfbb3995c8c577613f472a101&units=imperial`;
;
...
async function getWeather() {
  try {
    ...
    temp.textContent = `${data.current.temp.toFixed(1)}°F`;
